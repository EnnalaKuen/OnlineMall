<template>
  <div class="home">
    ...
    <van-grid column-num="5" icon-size="40">
      <van-grid-item v-for="item in navList" :key="item.id" :icon="item.imgUrl" :text="item.text"
    ...
    <div class="guess">
      ...
      <div class="goods-list">
        <GoodsItem v-for="item in proList" :key="item.id" :good="item"></GoodsItem>
      </div>
    </div>
  </div>
</template>
